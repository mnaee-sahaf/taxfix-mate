    ...
    const button = (
      <Comp
        ...
        className={cn(
          ...
          isActive && "group-data-[collapsible=icon]:!bg-primary/10 group-data-[collapsible=icon]:shadow-sm",
          className
        )}
        {...props}
      />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-full px-1 text-xs font-medium tabular-nums text-sidebar-foreground bg-primary/10 text-primary select-none pointer-events-none",
